      ...
      <div className={footerStyles.mainContent}>
          ...
          <div className={footerStyles.companySection}>
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>+91 9510925750</span>
              </div>
              <div className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconWrapper}>
                ...
                <span className={footerStyles.contactText}>
                  deeppatel7828@gmail.com@gmail.com
                </span>
              </div>
              <div className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconWrapper}>
                ...
                <span className={footerStyles.contactText}>Ahemdabad, India</span>
              </div>
            </div>
          </div>
        ...
        <div className={footerStyles.bottomSection}>
          ...
          <div className={footerStyles.designerText}>
            ...
            <a
              href="https://madicalservices.com/"
              target="_blank"
              rel="noopener noreferrer"
